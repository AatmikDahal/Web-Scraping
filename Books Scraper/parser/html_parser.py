...
class BooksParser():
    def __init__(self,page) -> None:
        self.soup = BeautifulSoup(page,'html.parser') #setting up the parsing object 
    ...
    def page_nums(self):
        ...
        pager = self.soup.select_one(BooksLocator.pager).string
        matcher = re.findall(pattern,pager) # in findall it give the pattern inside of () but in search it give ['full match','()']
        return  int(matcher[0]) #50 
